...
<head runat="server">
    <title>Register with exCHADia</title>
...
<body>
    ...
    <div class="register">
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server"  
            ContinueDestinationPageUrl="~/searchFlights.aspx">
            ...
            <WizardSteps>
                <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td align="center" colspan="2">Sign Up for Your exCHADia Account</td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Label ID="QuestionLabel" runat="server" AssociatedControlID="Question">Security Question:
                                    </asp:Label>
                                </td>
                                <td>
