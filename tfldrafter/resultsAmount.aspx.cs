...
public partial class resultsAmount : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string resOrder = "SELECT owner_name, winning_bid, player_name, pos, team FROM [draftResults] ORDER BY winning_bid DESC";
